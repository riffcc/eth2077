    ...
    GasRepricingSchedule {
        rules: vec![
            GasRepricingRule {
                ...
                old_gas: 20_000,
                new_gas: 5_000,
                rationale: "Reduce storage write bottleneck costs".to_string(),
            },
            GasRepricingRule {
                opcode: 0x54,
                category: OpcodeCategory::Storage,
                old_gas: 2_100,
                new_gas: 800,
                rationale: "Reduce storage read bottleneck costs".to_string(),
            },
            GasRepricingRule {
                opcode: 0x31,
                ...
                old_gas: 2_600,
                new_gas: 400,
                rationale: "Lower account state access overhead".to_string(),
            },
            GasRepricingRule {
                opcode: 0x3B,
                category: OpcodeCategory::Environment,
                old_gas: 2_600,
                new_gas: 400,
                rationale: "Lower external code size access overhead".to_string(),
            },
            GasRepricingRule {
                opcode: 0x3C,
                category: OpcodeCategory::Environment,
                old_gas: 2_600,
                new_gas: 400,
                rationale: "Lower external code copy access overhead".to_string(),
            },
            GasRepricingRule {
                opcode: 0x3F,
                category: OpcodeCategory::Environment,
                old_gas: 2_600,
                new_gas: 400,
                rationale: "Lower external code hash access overhead".to_string(),
            },
            GasRepricingRule {
                opcode: 0xF1,
                ...
                old_gas: 2_600,
                new_gas: 700,
                rationale: "Rebalance call overhead for throughput".to_string(),
            },
            GasRepricingRule {
                opcode: 0xFA,
                category: OpcodeCategory::Call,
                old_gas: 2_600,
                new_gas: 700,
                rationale: "Rebalance static call overhead for throughput".to_string(),
            },
            GasRepricingRule {
                opcode: 0xF4,
                category: OpcodeCategory::Call,
                old_gas: 2_600,
                new_gas: 700,
                rationale: "Rebalance delegate call overhead for throughput".to_string(),
            },
            GasRepricingRule {
                opcode: 0x20,
                ...
                old_gas: 30,
                new_gas: 36,
                rationale: "Align hashing cost with observed execution pressure".to_string(),
            },
            GasRepricingRule {
                opcode: 0xF0,
                ...
                old_gas: 32_000,
                new_gas: 48_000,
                rationale: "Increase contract creation cost for global balance".to_string(),
            },
            GasRepricingRule {
                opcode: 0xF5,
                category: OpcodeCategory::Create,
                old_gas: 32_000,
                new_gas: 48_000,
                rationale: "Increase deterministic creation cost for global balance".to_string(),
            },
        ],
        activation_block: 0,
